<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/locador/excluir" method="post" id="form_cadastro">
                <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $viewVar['locador']->getId(); ?>">

                <div class="panel panel-danger">
                    <div class="panel-body">
                        Deseja realmente excluir o locador: <?php echo $viewVar['locador']->getNome(); ?>?
                    </div>
