<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/locatario/excluir" method="post" id="form_cadastro">
                <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $viewVar['locatario']->getId(); ?>">

                <div class="panel panel-danger">
                    <div class="panel-body">
                        Deseja realmente excluir o locatário: <?php echo $viewVar['locatario']->getNome(); ?>?
                    </div>
